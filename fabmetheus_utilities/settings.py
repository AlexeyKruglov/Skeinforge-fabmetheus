...
class PluginFrame:
	...
	def createFrame( self, gridPosition ):
		...
		canvasHeight = min( 900, gridPosition.master.winfo_screenheight() - 540 ) - 6 - int( gridVertical.xScrollbar['width'] )
...
def addPreferenceOverride(moduleName, prefName, valueName):
    return None
