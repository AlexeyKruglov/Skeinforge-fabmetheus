...
def getCraftSequence():
	...
	return 'carve scale bottom preface widen inset fill multiply temperature speed raft skirt chamber tower jitter clip smooth stretch skin comb cool hop wipe oozebane dwindle splodge home lash fillet limit unpause dimension alteration export'.split()
